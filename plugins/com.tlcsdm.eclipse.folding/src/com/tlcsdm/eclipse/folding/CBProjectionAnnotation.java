...
import com.tlcsdm.eclipse.folding.theme.AnnotationThemeFactory;
import com.tlcsdm.eclipse.folding.theme.ProjectionAnnotationRangeIndicator;

/**
 * A common super class for all types of projection annotation. This
 * implementation wires in all of the theme-ing and painting support that
 * resides in the left gutter.
 * 
 * @author R.J. Lorimer
 */
public class CBProjectionAnnotation extends ProjectionAnnotation {
	 ...
	 * 
	 * It is recommended (and is structured in this class) that initializeImages is
	 * used in implementations of this method to populate any image fields.
	 * 
	 * @param display
	 * @return
	 */
