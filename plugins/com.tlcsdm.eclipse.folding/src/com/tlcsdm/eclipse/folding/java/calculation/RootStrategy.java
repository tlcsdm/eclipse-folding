...
public class RootStrategy extends AbstractCalculationStrategy implements CommentFoldingAdvisor {
	 ...
	 * regions that weren't captured by previous identifier collisions, because they
	 * will be assigned to the type by Eclipse.
	 * 
	 * @see com.tlcsdm.eclipse.folding.java.calculation.RegionCalculationStrategy#keepProcessing(int)
	 */
	 ...
	 * 
	 * If a package statement or import statement is found we flush the temporary
	 * regions into the permanant region collection, because everything above those
	 * identifiers belongs only to the RootStrategy.
	 * 
