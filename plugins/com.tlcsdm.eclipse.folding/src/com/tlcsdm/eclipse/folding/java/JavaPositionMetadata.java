...
import com.tlcsdm.eclipse.folding.PositionMetadata;
...
public class JavaPositionMetadata implements PositionMetadata {
	...
	public JavaPositionMetadata(boolean userDefined, boolean filterLastLine, boolean collapse, boolean overlaps,
			String owner) {
