...
import com.tlcsdm.eclipse.folding.java.user.UserDefinedEntry;
import com.tlcsdm.eclipse.folding.java.user.UserDefinedSettings;
import com.tlcsdm.eclipse.folding.java.user.UserDefinedSettingsEvent;
import com.tlcsdm.eclipse.folding.java.user.UserDefinedSettingsListener;
import com.tlcsdm.eclipse.folding.preferences.PreferencesTab;
import com.tlcsdm.eclipse.folding.util.GridDataFactory;
import com.tlcsdm.eclipse.folding.util.StringUtil;
...
public class UserDefinedTab implements PreferencesTab {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.tlcsdm.eclipse.folding.preferences.PreferencesTab#getTabControl(org.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.tlcsdm.eclipse.folding.preferences.PreferencesTab#getTabName()
	 */
	...
	private void createTypeSettings(Composite group) {
		...
		delete.addListener(SWT.Selection, new Listener() {
			...
			public void handleEvent(Event event) {
				UserDefinedEntry removed = (UserDefinedEntry) ((IStructuredSelection) viewer.getSelection())
						.getFirstElement();
