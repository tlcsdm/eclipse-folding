...
import com.tlcsdm.eclipse.folding.util.IntStack;
...
public abstract class AbstractBlockStrategy extends AbstractCalculationStrategy {
	...
	/**
	 * Push left braces, pop right braces and calculate the distance in between as a
	 * region.
	 * 
	 * @see com.tlcsdm.eclipse.folding.java.calculation.RegionCalculationStrategy#handle(int,
	 ...
	 * 
	 * @see com.tlcsdm.eclipse.folding.java.calculation.CalculationStrategy#keepProcessing(int)
	 */
	 ...
	 * 
	 * This may mean that in the case of mismatched braces we are looking for the
	 * broadest set of braces, or it may simply mean that it is looking for a
	 * matching brace.
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @see
	 * com.tlcsdm.eclipse.folding.calculation.RegionCalculationStrategy#result()
	 */
