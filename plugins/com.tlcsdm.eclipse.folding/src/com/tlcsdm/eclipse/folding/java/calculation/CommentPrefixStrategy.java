...
public class CommentPrefixStrategy extends CompositeCalculationStrategy {
	 ...
	 * composite.
	 * 
	 * @see com.tlcsdm.eclipse.folding.java.calculation.CalculationStrategy#handle(int)
	 */
	...
	/**
	 * Make a determination if the token is a comment or some type information. If
	 * the token belongs to a type, disable the comment strategy, and enable the
	 ...
	 * 
	 * @see com.tlcsdm.eclipse.folding.java.calculation.CalculationStrategy#result()
	 */
