package com.tlcsdm.eclipse.folding.java.preferences;
...
public final class Defaults {
	...
	public static final Boolean COLLAPSE_INNER_TYPES = Boolean.TRUE;
	public static final Boolean FOLD_INNER_TYPES = Boolean.TRUE;
	public static final Boolean COLLAPSE_TOP_TYPES = Boolean.FALSE;
	public static final Boolean FOLD_TOP_TYPES = Boolean.TRUE;
	public static final Boolean COLLAPSE_COMMENT_BLOCKS = Boolean.TRUE;
	public static final Boolean FOLD_COMMENT_BLOCKS = Boolean.TRUE;
	public static final Boolean COLLAPSE_JAVADOCS = Boolean.TRUE;
	public static final Boolean FOLD_JAVADOCS = Boolean.TRUE;
	public static final Boolean COLLAPSE_LINE_COMMENTS = Boolean.FALSE;
	public static final Boolean FOLD_LINE_COMMENTS = Boolean.TRUE;
	public static final Boolean COLLAPSE_HEADER = Boolean.TRUE;
	public static final Boolean FOLD_HEADER = Boolean.TRUE;
	public static final Boolean COLLAPSE_IMPORTS = Boolean.TRUE;
	public static final Boolean FOLD_IMPORTS = Boolean.TRUE;
	public static final Boolean COLLAPSE_STATICS = Boolean.TRUE;
	public static final Boolean FOLD_STATICS = Boolean.TRUE;
	public static final Boolean COLLAPSE_METHODS = Boolean.FALSE;
	public static final Boolean FOLD_METHODS = Boolean.TRUE;
	public static final Boolean COLLAPSE_CONSTRUCTORS = Boolean.FALSE;
	public static final Boolean FOLD_CONSTRUCTORS = Boolean.TRUE;
	public static final Boolean FOLD_MAIN_METHODS = Boolean.TRUE;
	public static final Boolean COLLAPSE_MAIN_METHODS = Boolean.FALSE;
	public static final Boolean COLLAPSE_GETTER_SETTER = Boolean.TRUE;
	public static final Boolean FOLD_GETTER_SETTER = Boolean.TRUE;
	public static final Boolean FOLD_USER_DEFINED = Boolean.FALSE;
	public static final Boolean COLLAPSE_USER_DEFINED = Boolean.TRUE;

	public static final Boolean LAST_LINE_METHOD = Boolean.FALSE;
	public static final Boolean LAST_LINE_TYPE = Boolean.FALSE;
	public static final Boolean LAST_LINE_CONTROL = Boolean.FALSE;
	public static final Boolean LAST_LINE_COMMENT = Boolean.FALSE;
